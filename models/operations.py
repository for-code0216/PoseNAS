...
OPS = {
    ...
    'spatial_wise': lambda C, stride, affine: Spatial_Wise(C),
...
class Spatial_Wise(nn.Module):

    def __init__(self, C_in):
        super().__init__()
        self.conv = nn.Conv2d(C_in, 1, 1, 1, 0, bias=False)
...
class SE_Block(nn.Module):
    ...
    def __init__(self, C_in, affine=True):
        ...
        self.fc1 = nn.Conv2d(C_in, C_in, 1, 1, 0)
        self.fc2 = nn.Conv2d(C_in, C_in, 1, 1, 0)
        self.relu = nn.ReLU()
